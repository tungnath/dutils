...
fun App() {
    ...
    // Check the preference store for existing session to decide start route
...
//    // Test individual screens UI
//    MaterialTheme {
//        NotificationScreen(NotificationViewModel(), onNavigateUpToHomeScreen = {})
//    }
